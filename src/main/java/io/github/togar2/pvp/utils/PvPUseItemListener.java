...
public class PvPUseItemListener {
	// Copied from Minestom, except also triggering eating when the item is a milk bucket or a potion
	public static void useItemListener(ClientUseItemPacket packet, Player player) {
		...
		} else if (material.isFood() || material == Material.MILK_BUCKET || material == Material.POTION) {
