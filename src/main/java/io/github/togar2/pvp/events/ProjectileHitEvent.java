...
import io.github.togar2.pvp.projectile.CustomEntityProjectile;
...
/**
 * Called when an {@link io.github.togar2.pvp.projectile.CustomEntityProjectile} hits an entity or a block.
 * <br>
...
public abstract class ProjectileHitEvent implements EntityInstanceEvent {
	//TODO replace with Minestoms ProjectileCollideEvent
	...
	/**
	 * Called when a {@link io.github.togar2.pvp.projectile.CustomEntityProjectile} hits a block.
	 * <br>
	...
	/**
	 * Called when a {@link io.github.togar2.pvp.projectile.CustomEntityProjectile} hits an entity.
