...
public class DamageListener {
	...
	public static boolean totemProtection(LivingEntity entity, DamageTypeInfo typeInfo) {
	...
	public static float getDamageWithProtection(LivingEntity entity, DamageTypeInfo typeInfo,
	                                            float amount, DamageConfig config) {
		amount = getDamageWithArmor(entity, typeInfo, amount, config);
		return getDamageWithEnchantments(entity, typeInfo, amount, config);
	}
	
	public static float getDamageWithArmor(LivingEntity entity, DamageTypeInfo typeInfo,
	                                       float amount, DamageConfig config) {
	...
	public static float getDamageWithEnchantments(LivingEntity entity, DamageTypeInfo typeInfo,
	                                              float amount, DamageConfig config) {
