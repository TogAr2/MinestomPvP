...
public class FoodComponents {
	...
	public static final FoodComponent SUSPICIOUS_STEW = createSoup(6, Material.SUSPICIOUS_STEW);
	...
	private static FoodComponent createSoup(int hunger, Material material) {
		return new FoodComponent.Builder().hunger(hunger).saturationModifier(0.6F).build(material);
	}
