...
public class CustomPotionEffects {
	...
	public static void registerAll() {
		register(
				...
				new CustomPotionEffect(PotionEffect.STRENGTH, 9643043).addAttributeModifier(Attribute.ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 3.0F, AttributeOperation.ADDITION),
