...
public class CustomPotionEffects {
	...
	public static void registerAll() {
		register(
				new CustomPotionEffect(PotionEffect.MOVEMENT_SPEED, 8171462).addAttributeModifier(Attribute.MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", (float) 0.20000000298023224D, AttributeOperation.MULTIPLY_TOTAL),
				new CustomPotionEffect(PotionEffect.MOVEMENT_SLOWDOWN, 5926017).addAttributeModifier(Attribute.MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", (float) -0.15000000596046448D, AttributeOperation.MULTIPLY_TOTAL),
				new CustomPotionEffect(PotionEffect.DIG_SPEED, 14270531).addAttributeModifier(Attribute.ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", (float) 0.10000000149011612D, AttributeOperation.MULTIPLY_TOTAL),
				new CustomPotionEffect(PotionEffect.DIG_SLOWDOWN, 4866583).addAttributeModifier(Attribute.ATTACK_SPEED, "55FCED67-E92A-486E-9800-B47F202C4386", (float) -0.10000000149011612D, AttributeOperation.MULTIPLY_TOTAL),
				new CustomPotionEffect(PotionEffect.DAMAGE_BOOST, 9643043).addAttributeModifier(Attribute.ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 3.0F, AttributeOperation.ADDITION),
				new InstantPotionEffect(PotionEffect.HEAL, 16262179),
				new InstantPotionEffect(PotionEffect.HARM, 4393481),
				new CustomPotionEffect(PotionEffect.JUMP, 2293580),
				new CustomPotionEffect(PotionEffect.CONFUSION, 5578058),
				new CustomPotionEffect(PotionEffect.REGENERATION, 13458603),
				new CustomPotionEffect(PotionEffect.DAMAGE_RESISTANCE, 10044730),
				...
				new CustomPotionEffect(PotionEffect.WEAKNESS, 4738376).addAttributeModifier(Attribute.ATTACK_DAMAGE, "22653B89-116E-49DC-9B6B-9971489B5BE5", -4.0F, AttributeOperation.ADDITION),
