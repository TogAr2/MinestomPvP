...
public class CustomPotionTypes {
	...
	public static void registerAll() {
		register(
				...
				new CustomPotionType(PotionType.LEAPING, new Potion(PotionEffect.JUMP_BOOST, (byte) 0, 3600)),
				new CustomPotionType(PotionType.LONG_LEAPING, new Potion(PotionEffect.JUMP_BOOST, (byte) 0, 9600)),
				new CustomPotionType(PotionType.STRONG_LEAPING, new Potion(PotionEffect.JUMP_BOOST, (byte) 1, 1800)),
				...
				new CustomPotionType(PotionType.SWIFTNESS, new Potion(PotionEffect.SPEED, (byte) 0, 3600)),
				new CustomPotionType(PotionType.LONG_SWIFTNESS, new Potion(PotionEffect.SPEED, (byte) 0, 9600)),
				new CustomPotionType(PotionType.STRONG_SWIFTNESS, new Potion(PotionEffect.SPEED, (byte) 1, 1800)),
				new CustomPotionType(PotionType.SLOWNESS, new Potion(PotionEffect.SLOWNESS, (byte) 0, 1800)),
				new CustomPotionType(PotionType.LONG_SLOWNESS, new Potion(PotionEffect.SLOWNESS, (byte) 0, 4800)),
				new CustomPotionType(PotionType.STRONG_SLOWNESS, new Potion(PotionEffect.SLOWNESS, (byte) 3, 400)),
				new CustomPotionType(PotionType.TURTLE_MASTER, new Potion(PotionEffect.SLOWNESS, (byte) 3, 400), new Potion(PotionEffect.RESISTANCE, (byte) 2, 400)),
				new CustomPotionType(PotionType.LONG_TURTLE_MASTER, new Potion(PotionEffect.SLOWNESS, (byte) 3, 800), new Potion(PotionEffect.RESISTANCE, (byte) 2, 800)),
				new CustomPotionType(PotionType.STRONG_TURTLE_MASTER, new Potion(PotionEffect.SLOWNESS, (byte) 5, 400), new Potion(PotionEffect.RESISTANCE, (byte) 3, 400)),
				...
				new CustomPotionType(PotionType.HEALING, new Potion(PotionEffect.INSTANT_HEALTH, (byte) 0, 1)),
				new CustomPotionType(PotionType.STRONG_HEALING, new Potion(PotionEffect.INSTANT_HEALTH, (byte) 1, 1)),
				new CustomPotionType(PotionType.HARMING, new Potion(PotionEffect.INSTANT_DAMAGE, (byte) 0, 1)),
				new CustomPotionType(PotionType.STRONG_HARMING, new Potion(PotionEffect.INSTANT_DAMAGE, (byte) 1, 1)),
				new CustomPotionType(PotionType.POISON, new Potion(PotionEffect.POISON, (byte) 0, 900)),
				new CustomPotionType(PotionType.LONG_POISON, new Potion(PotionEffect.POISON, (byte) 0, 1800)).legacy(new Potion(PotionEffect.POISON, (byte) 0, 2400)),
				...
				new CustomPotionType(PotionType.LONG_REGENERATION, new Potion(PotionEffect.REGENERATION, (byte) 0, 1800)).legacy(new Potion(PotionEffect.REGENERATION, (byte) 0, 2400)),
				new CustomPotionType(PotionType.STRONG_REGENERATION, new Potion(PotionEffect.REGENERATION, (byte) 1, 450)),
				new CustomPotionType(PotionType.STRENGTH, new Potion(PotionEffect.STRENGTH, (byte) 0, 3600)),
				new CustomPotionType(PotionType.LONG_STRENGTH, new Potion(PotionEffect.STRENGTH, (byte) 0, 9600)),
				new CustomPotionType(PotionType.STRONG_STRENGTH, new Potion(PotionEffect.STRENGTH, (byte) 1, 1800)),
